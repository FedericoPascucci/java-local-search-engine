...
//Implementation of Martin Porter's Stemming Algorithm (1980).
//Open-source standard for Information Retrieval in the English language.
//Original Java implementation by Martin Porter. Adapted for this project.
...
public class Stemmer {
    ...
    private final void step5() {
        ...
        switch (b[k - 1]) {
            ...
            case 'n': if (ends("ant")) break; if (ends("ement")) break;
                      if (ends("ment")) break; if (ends("ent")) break; return;
    ...
    // method added to match TextCleaner class
    
    public static String trovaRadice(String parola){
